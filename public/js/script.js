...
var Readimage = function () {
  ...
  _createClass(Readimage, [{
    key: "loadElemmentImage",
    value: function loadElemmentImage() {
      var _this = this;
    ...
    key: "loadimage",
    value: function loadimage(target_img) {
      var _this = this;
...
var _readimage = require('./lib/readimage');
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)(".tab_swich").click(function () {
    (0, _jquery2.default)('.tab_swich').removeClass(CURSOR_CLASS);
    (0, _jquery2.default)('.tab').removeClass(CURSOR_CLASS);
    (0, _jquery2.default)(this).addClass(CURSOR_CLASS);
    var index = (0, _jquery2.default)('.tab_swich').index(this);
    (0, _jquery2.default)(".tab").eq(index).addClass(CURSOR_CLASS);
  });
});

},{"./lib/readimage":2,"jquery":1}]},{},[3]);
